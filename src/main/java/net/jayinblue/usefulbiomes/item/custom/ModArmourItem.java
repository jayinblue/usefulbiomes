...
import net.jayinblue.usefulbiomes.item.ModArmourMaterial;
...
public class ModArmourItem extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffect> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffect>())
                    .put(ModArmourMaterial.AMETHYST_REINFORCED_DIAMOND, StatusEffects.REGENERATION)
                    .put(ModArmourMaterial.AMETHYST_REINFORCED_NETHERITE, StatusEffects.REGENERATION).build();
